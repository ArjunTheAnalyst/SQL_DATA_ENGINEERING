# 📊 SQL Data Engineer Portfolio: ETL, Warehousing & Analytics
A collection of end-to-end data engineering projects demonstrating ETL pipeline development, dimensional modeling, and data mart architecture using DuckDB and SQL.
...
Language: SQL (DDL, DML, advanced)
Tools: VS Code, Git, GCS

# 🔧 Skills Demonstrated
1. ETL Pipeline Development
2. Star Schema Dimensional Modeling
3. Advanced SQL (CTEs, Window Functions, MERGE)
4. Idempotent Scripts & Incremental Updates
